...
namespace Service.Migrations
{
    ...
    [Migration("20250513010535_RemoveCreateNewUserOnEvryAddedWorkout")]
    partial class RemoveCreateNewUserOnEvryAddedWorkout
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Service.Domain.Models.Workout", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Service.Domain.Models.Workout", b =>
                {
                    b.HasOne("Service.Domain.Models.User", "User")
                        .WithMany("Workouts")
